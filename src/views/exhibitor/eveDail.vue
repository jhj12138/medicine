        ...
        <li v-for="(item, index) in list" :key="index">
          ...
          <div class="evedail_li_bottom">
            ...
            <div class="evedail_li_share" >
              <a :href=" 'https://www.zjylz.com'+ item.meal" v-if="item.meal">下载餐券</a>
              <span @click="dowlond" v-else>等待审核</span>
              <a :href=" 'https://www.zjylz.com'+ item.ticket" v-if="item.ticket">下载门票</a>
              <span @click="dowlond" v-else>等待审核</span>
            </div>
          </div>
        </li>
