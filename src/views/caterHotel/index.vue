<template>
  <div id = "caterHotel">
    <div class="caterHotel_top">
      <div class="caterHotel_return">
        <img src="../../assets/image/mine_return.png" alt="">
      </div>
      <div class="caterHotel_middle">周边餐饮酒店</div>
    </div>
    <div class="caterHotel_con">
      <div class="caterHotel_ul" v-for="(item,index) in hotelList" :key="item.tit">
        <div class="caterHotel_tit">{{item.tit}}</div>
        <div class="caterHotel_li" v-for="(items,index2) in item.con" :key ='index2' >
          <div class="caterHotel_li_left">
            <img src="../../assets/image/fore_img.png" alt="">
          </div>
          <div class="caterHotel_li_right">
            <div class="caterHotel_li_name">{{items.name}}</div>
            <div class="caterHotel_li_address">地址：杭州市西湖区</div>
            <div class="caterHotel_li_phone">电话：13788330060</div>
