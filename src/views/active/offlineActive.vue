...
import {offlineJoin} from '../../api/home'
export default {
  data() {
    return {
      CurPage:0,
  ...
  methods:{
    ...
    goDetail(ids) {
      this.$router.push({ path: '/offlinedetail', query: { Id: ids} })
    },
    loadMore() {
      // this.tabContents =[]
      this.busy = true
