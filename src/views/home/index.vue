  ...
  <div id="home">
      ...
      <div class="home_tit" @click="goHref($event)">
        ...
        <div class="home_tits">
          <div class="home_tit_left">
            <div class="home_titlec">
              <img src="../../assets/image/home_titlec.png" alt="" />
            </div>
            <div class="home_titlee">
              <img src="../../assets/image/home_titlee.png" alt="" />
            </div>
          </div>
        ...
        <div class="home_textboxs">
          <div class="home_textbox_left" @click="goUp">
            <div class="home_textbox_lefts">
              <span>展品</span>
              <div class="home_textbox_img">
                <img src="../../assets/image/home_san.png" alt="" />
              </div>
            </div>
            <div class="home_textup" @click="goUps" v-if="flagUp">展商</div>
          </div>
          <div class="home_textbox_right">
            <div class="home_textbox_shou">
              <img src="../../assets/image/home_shou.png" alt="" />
            </div>
    ...
    <div class="home_hall">
      ...
      <div class="home_hall_right">
        <!-- 解开注释跳报名 -->
        <div class="home_hall_top" @click="goExam" v-if="isopen">
          <!-- <div class="home_hall_top" @click="gosubmit1"> -->
          <span>立即参展</span>
          <img src="../../assets/image/home_hall2.png" alt="" />
        </div>
        <div class="home_hall_bottm" @click="gosubmit2" v-if="isopen">
          <span>立即采购</span>
    ...
    <div class="home_tab">
      <ul>
        <li
          ...
          @click="getNum(index, item.classid)"
        >
          {{ item.name }}
        </li>
      </ul>
    ...
    <div class="home_inform">
      ...
      <div class="home_inform_tit">
        浙江国际科研、医疗仪器设备技术交流展览会
      </div>
      ...
      <div class="home_coop_swiper">
        <div class="swiper-container2">
          <div class="swiper-wrapper">
            <div
              class="swiper-slide swiper_item"
              v-for="(item, index) in swiper_two"
              :key="index"
            >
              <div
                class="home_coop_list"
...
export default {
  ...
  data() {
    return {
      ...
      tab_li: [
        { name: "展会动态", classid: "9" },
        { name: "国际合作", classid: "10" },
        { name: "政府采购", classid: "11" },
        { name: "学术论坛", classid: "12" },
        { name: "资料下载", classid: "13" },
      ],
      num: 0,
      review_index: 0,
      Mobileimg: null,
  ...
  methods: {
    ...
    goExam() {
      ...
      Dialog.alert({
        message: "请前往浙江国际科研医疗仪器数字化服务平台（http://www.zjylz.com）进行登录操作",
      }).then(() => {
        // on close
      });
      // Toast(
      //   "请前往浙江国际科研医疗仪器数字化服务平台（http://www.zjylz.com）进行登录操作"
      // );
      // if(cid){
