      ...
      <ul>
        ...
        >
          <div class="message_li_top">
            <div class="message_li_left">
              ...
              <div class="message_li_jin">
               ...
               <div class="message_li_right" v-show="flag">
          ...
          <div class="message_li_bottom">
            <div class="message_li_span"><div class="message_li_tit">地点<span></span></div>：<span>{{item.Address}}</span></div>
            <div class="message_li_span"><div class="message_li_tit">类型<span></span></div>：<span>{{item.Type}}</span></div>
            <div class="message_li_span"><div class="message_li_tit">报名时间<span></span></div>：<span>{{item.CreateTime}}</span></div>
            <div class="message_li_span"><div class="message_li_tit">活动时间<span></span></div>：<span>{{item.ActivityTime}} -- {{item.ActivityTimeEnd}}</span></div>
          </div>
        </li>
      </ul>
    </div>
