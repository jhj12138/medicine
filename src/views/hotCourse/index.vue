<template>
  <div id = "hotCourse">
    ...
    <div class="login_con">
        <div class="new_top">
            <video src="../../assets/image/home-vid.mp4" controls="none" class="none"></video>
            <img src="../../assets/image/ho-a.png" alt="" class="ho-a">
            ...
            <div class="he-zi">
                ...
                <div>
                    <span>浏览量：999次</span>
                    <span>课程时长：2小时</span>
                    <span>发布时间：2020.8.10 12:00</span>
                </div>
            </div>
        </div>
    </div>
    <div class="hot-top">
        ...
        <div class="hot-b">
            ...
            <div class="hot-d" v-show="indd==1">
                <div class="hot-da">
                    <img src="../../assets/image/dity_img.png" alt="">
                    <div>瑞士ICO精密医疗器械专家 铁别讲座</div>
                </div>
                <div class="hot-da">
                    <img src="../../assets/image/dity_img.png" alt="">
                    <div>瑞士ICO精密医疗器械专家 铁别讲座</div>
